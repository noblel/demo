...
if(NOT TARGET ippicv)
  ...
  set_target_properties(ippicv PROPERTIES
    ...
    IMPORTED_LOCATION "${OpenCV_INSTALL_PATH}/opencv341/native/3rdparty/libs/x86_64/libippicv.a"
  )
endif()
...
set(OpenCV_INCLUDE_DIRS "${OpenCV_INSTALL_PATH}/opencv341/native/jni/include" "${OpenCV_INSTALL_PATH}/opencv341/native/jni/include/opencv")
