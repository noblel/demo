...
clAmdFftStatus(*clAmdFftBakePlan)(clAmdFftPlanHandle plHandle, cl_uint numQueues,
                                  cl_command_queue *commQueueFFT, void (CL_CALLBACK
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftCreateDefaultPlan)(clAmdFftPlanHandle *plHandle, cl_context context,
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftEnqueueTransform)(clAmdFftPlanHandle plHandle, clAmdFftDirection dir,
                                          cl_uint numQueuesAndEvents, cl_command_queue *commQueues,
                                          cl_uint numWaitEvents, const cl_event *waitEvents,
                                          cl_event *outEvents, cl_mem *inputBuffers,
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftGetTmpBufSize)(const clAmdFftPlanHandle plHandle, size_t *buffersize);

extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftGetVersion)(cl_uint *major, cl_uint *minor, cl_uint *patch);

extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftSetLayout)(clAmdFftPlanHandle plHandle, clAmdFftLayout iLayout,
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftSetPlanInStride)(clAmdFftPlanHandle plHandle, const clAmdFftDim dim,
                                         size_t *clStrides);
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftSetPlanOutStride)(clAmdFftPlanHandle plHandle, const clAmdFftDim dim,
                                          size_t *clStrides);
...
extern CL_RUNTIME_EXPORT
clAmdFftStatus(*clAmdFftSetPlanScale)(clAmdFftPlanHandle plHandle, clAmdFftDirection dir,
                                      cl_float scale);
